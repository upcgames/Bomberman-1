...
namespace Bomberman
{
	Nivel4::Nivel4()
	{
		Objetos matriz[9][13] = {
			...
			{ oCaja, oCaja, oCaja, oPiso, oCaja, oPiso, oPiso, oPiso, oCaja, oPiso, oPiso, oPiso, oPiso },
			{ oCaja, oBloque, oPiso, oBloque, oPiso, oBloque, oPiso, oBloque, oPiso, oBloque, oPiso, oBloque, oPiso },
			{ oPiso, oPiso, oCaja, oPiso, oPiso, oPiso, oCaja, oPiso, oCaja, oPiso, oCaja, oPiso, oCaja },
			{ oPiso, oBloque, oPiso, oBloque, oPiso, oBloque, oPiso, oBloque, oPiso, oBloque, oPiso, oBloque, oPiso },
		...
		arregloMalignos->arreglo[0] = gcnew Maligno1(gcnew Posicion(384, 384), 0);
		arregloMalignos->arreglo[1] = gcnew Maligno1(gcnew Posicion(768, 0), 0);
		arregloMalignos->arreglo[2] = gcnew Maligno1(gcnew Posicion(512, 64), 0);
		arregloMalignos->arreglo[3] = gcnew Maligno1(gcnew Posicion(768, 512), 0);
	}
}